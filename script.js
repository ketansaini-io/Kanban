...
function Sidebar({ xp, tasks, columns, theme, setTheme, focusMode, setFocusMode, onNewTask }) {
...
function TopBar({ search, setSearch, filterPri, setFilterPri, searchRef, focusMode }) {
  return (
...
function KanbanApp() {
  ...
  /* ----- Persisted state ----- */
  const [tasks,    setTasks]    = useState(() => readLS("kbp-tasks",   DEFAULT_TASKS));
  ...
  return (
    <div className="app-layout">
      ...
      <Sidebar
        ...
        onNewTask={() => setModal({ task: {}, colId: "todo" })}
      />
